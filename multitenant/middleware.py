...
Utilisez ces imports à la place:

from multitenant.middleware import get_current_tenant, set_current_tenant
from multitenant.middleware import TenantMiddleware, TenantContext
"""
