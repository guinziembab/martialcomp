...
from multitenant.utils import get_tenant_for_request
...
class TenantThemeMiddleware(MiddlewareMixin):
    """
    Middleware qui ajoute les informations de thème du tenant à la requête.
    """
    def process_request(self, request):
        """
        Ajoute les données de thème à la requête.
        """
    ...
    def process_template_response(self, request, response):
        """
        Ajoute le contexte de thème à la réponse template.
        """
...
class TenantTemplateMiddleware(MiddlewareMixin):
    ...
    def process_template_response(self, request, response):
        """
        Modifie le template à utiliser si une version spécifique au tenant existe.
        """
        ...
        if isinstance(original_template, (list, tuple)):
            ...
            # Mettre à jour le template_name dans la réponse
    ...
    def _get_tenant_template_name(self, template_name, tenant):
        ...
        """
        # Ignore déjà les templates tenant
