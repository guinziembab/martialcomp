"""
Service de paiement pour la gestion des abonnements et fonctionnalités à l'usage
"""
...
class PaymentService:
    """
    Service pour gérer les paiements, abonnements et facturation des fonctionnalités à l'usage.
    """
    ...
    def create_subscription(self, tier_id, billing_cycle):
        ...
        try:
            ...
            if active_subscription:
                # Annuler l'abonnement existant à la fin de la période
    ...
    def cancel_subscription(self, subscription_id, immediate=False):
        ...
        Args:
            ...
            immediate: Annuler immédiatement ou à la fin de la période
        ...
        try:
            ...
            if immediate:
                ...
                subscription.status = 'active'  # Reste actif jusqu'à la date de fin
    ...
    def process_pay_per_use_charges(self, billing_cycle_end_date=None):
        """
        Traite les frais d'utilisation des fonctionnalités à l'usage.
    ...
    def apply_promotion_code(self, code, tier_id, billing_cycle):
        """
        Applique un code promotionnel à un abonnement.
...
def check_feature_availability(tenant, feature_key):
    ...
    try:
        ...
        # Si non incluse dans l'abonnement, vérifier si c'est une fonctionnalité à l'usage
        try:
...
def record_feature_usage(tenant, feature_key, quantity=1):
    """
    Enregistre l'utilisation d'une fonctionnalité à l'usage.
    
    Args:
        tenant: Objet tenant
        feature_key: Identifiant de la fonctionnalité
        quantity: Quantité d'utilisation à enregistrer
