...
from multitenant.db_optimization import IndexManager, PerformanceMonitor
import logging
...
class Command(BaseCommand):
    ...
    def analyze_tables(self, tenant):
        ...
        self.stdout.write(self.style.SUCCESS('  ✓ Tables analyzed'))
        ...
        with connection.cursor() as cursor:
            ...
            for table_name, in tables:
                try:
                    ...
                    self.stdout.write(f'    ✓ Vacuumed {table_name}')
                except Exception as e:
                    self.stdout.write(self.style.WARNING(f'    ⚠ Could not vacuum {table_name}: {e}'))
