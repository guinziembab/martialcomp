...
class Command(BaseCommand):
    ...
    def display_general_stats(self):
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING('  ⚠️  Le champ is_migrated n\'existe pas encore'))
        ...
        try:
            ...
            self.stdout.write(self.style.WARNING('  ⚠️  Les tables multitenant n\'existent pas encore'))
        
        stats = [
            ['Total de clubs', total_clubs],
            ['Clubs migrés', migrated_clubs],
            ['Clubs à migrer', pending_clubs],
    ...
    def display_pending_clubs(self):
        ...
        self.stdout.write(self.style.WARNING('2. Clubs à migrer (10 premiers)'))
    ...
    def display_existing_tenants(self):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR('  ❌ Les tables multitenant n\'existent pas'))
    ...
    def get_club_practitioners_count(self, club):
        ...
        # Sinon, essayer via le champ club (peut-être legacy)
        try:
    ...
    def display_recommendations(self):
        ...
        if pending_count > 0:
            self.stdout.write(f'  1. {pending_count} clubs restent à migrer')
        ...
        self.stdout.write('\n  ⚠️  Assurez-vous que toutes les migrations sont appliquées:')
