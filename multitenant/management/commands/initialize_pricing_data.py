...
from multitenant.models import SubscriptionTier, PayPerUseFeature, PromotionCode

class Command(BaseCommand):
    help = 'Initialise les données de tarification avec les niveaux d\'abonnement et les fonctionnalités à l\'usage'
    ...
    def handle(self, *args, **options):
        ...
        # Créer les fonctionnalités à l'usage
        PayPerUseFeature.objects.create(
            name="additional_participants",
            description="Participants supplémentaires au-delà de la limite du plan",
            price_per_unit=2.50,
        ...
        PayPerUseFeature.objects.create(
            ...
            description="Stockage supplémentaire au-delà de la limite du plan",
            price_per_unit=5.00,
            unit_label="par Go"
        )
        ...
        from multitenant.models.pricing import PromotionCode
