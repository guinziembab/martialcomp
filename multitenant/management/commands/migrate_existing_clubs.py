...
from grades.models import Grade, PractitionerGrade, GradeRequirement
from finances.models import Invoice, PaymentAttempt
    ...
    def migrate_all_clubs(self, club_ids: Optional[List[int]] = None):
        ...
        for club in clubs:
            try:
                ...
                logger.error(f"Échec migration club {club.id}: {e}", exc_info=True)
