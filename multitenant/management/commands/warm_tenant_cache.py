...
from multitenant.cache import CacheManager, tenant_cache
from competitions.models import Competition, Practitioner, Registration
import logging
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for tenant in tenants:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS(f'  ✓ Cached {cached_items} item groups'))
    ...
    def cache_tenant_settings(self, tenant, timeout):
        ...
        self.stdout.write('    ✓ Settings cached')
    ...
    def cache_club_metadata(self, tenant, timeout):
        ...
        self.stdout.write('    ✓ Metadata cached')
    ...
    def cache_dashboard_data(self, tenant, timeout):
        ...
        self.stdout.write('    ✓ Dashboard data cached')