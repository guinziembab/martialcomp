...
class Domain(models.Model):
    ...
    Permet à une organisation d'avoir plusieurs domaines pointant vers le même tenant.
    """
...
class TenantFeature(models.Model):
    ...
    Permet une personnalisation fine au-delà des plans standards.
    """
    tenant = models.ForeignKey(
        Tenant,
        on_delete=models.CASCADE,
    ...
    metadata = models.JSONField(
        _("Métadonnées"),
        default=dict,
        help_text="Configuration spécifique à la fonctionnalité"
    )
...
class TenantSubscription(models.Model):
    """
    Représente l'abonnement d'un tenant à un niveau spécifique.
    """
...
class PayPerUseFeature(models.Model):
    """
    Fonctionnalités disponibles en paiement à l'usage.
    """
    name = models.CharField(_("Nom"), max_length=100)
    description = models.TextField(_("Description"))
    ...
    class Meta:
        verbose_name = _("Fonctionnalité à l'usage")
        verbose_name_plural = _("Fonctionnalités à l'usage")
        ordering = ['name']
...
class FeatureUsage(models.Model):
    """
    Enregistre l'utilisation des fonctionnalités à l'usage.
    """
...
class PromotionCode(models.Model):
    ...
    valid_until = models.DateTimeField(_("Valide jusqu'à"))
