...
from multitenant.security import SecurityAuditor, run_security_audit, TENANT_SECURITY_REPORT_PATH
...
class SecurityDashboardView(LoginRequiredMixin, SuperAdminRequiredMixin, TemplateView):
    ...
    def _get_security_stats(self, reports):
        """Calcule les statistiques de sécurité à partir des rapports."""
        stats = {
    ...
    def get_form_class(self):
        ...
        class SecurityAuditForm(forms.Form):
            ...
            TESTS = (
                ...
                ('security_headers', _("En-têtes de sécurité")),
            ...
            tests_to_run = forms.MultipleChoiceField(
                ...
                label=_("Tests à exécuter"),
                help_text=_("Sélectionnez les tests à exécuter. Laissez vide pour tous les exécuter.")
            )
...
class SecurityViolationsView(LoginRequiredMixin, SuperAdminRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        for violation in violations:
            ...
            elif 'En-tête' in description or 'header' in description:
