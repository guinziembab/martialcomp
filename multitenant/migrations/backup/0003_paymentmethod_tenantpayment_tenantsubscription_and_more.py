# Generated by Django 5.1.4 on 2025-05-18 23:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameIndex(
            model_name='tenant',
            new_name='multitenant_domain_5f6a4e_idx',
            old_name='multitenant_domain_a0ac80_idx',
        ),
        migrations.RenameIndex(
            model_name='tenant',
            new_name='multitenant_schema__b64901_idx',
            old_name='multitenant_schema__9f8a1d_idx',
        ),
        migrations.RenameIndex(
            model_name='tenant',
            new_name='multitenant_is_acti_818ec6_idx',
            old_name='multitenant_is_acti_c7c8a0_idx',
        ),

        migrations.AlterField(
            model_name='tenant',
            name='schema_name',
            field=models.CharField(max_length=63, unique=True, validators=[django.core.validators.RegexValidator(message='Le nom du schéma doit commencer par une lettre et contenir uniquement des lettres minuscules, chiffres et underscores.', regex='^[a-z][a-z0-9_]*$')], verbose_name='Nom du schéma PostgreSQL'),
        ),
        migrations.AlterField(
            model_name='tenant',
            name='slug',
            field=models.SlugField(unique=True, validators=[django.core.validators.MinLengthValidator(3), django.core.validators.RegexValidator(message='Seuls les lettres minuscules, chiffres et tirets sont autorisés.', regex='^[a-z0-9-]+$')], verbose_name='Identifiant'),
        ),
        migrations.AlterField(
            model_name='tenant',
            name='updated_at',
        ...
        migrations.AddField(
            ...
            name='tenant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_methods', to='multitenant.tenant', verbose_name='Tenant'),
        ),
        migrations.AddField(
            model_name='tenantpayment',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_payments', to=settings.AUTH_USER_MODEL, verbose_name='Créé par'),
        ),
        migrations.AddField(
            model_name='tenantpayment',
            name='tenant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='multitenant.tenant', verbose_name='Tenant'),
        ),
        migrations.AddField(
            model_name='tenantsubscription',
            name='tenant',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='subscription', to='multitenant.tenant', verbose_name='Tenant'),
        ),
