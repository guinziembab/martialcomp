...
from ..views import federations
from ..views.competitions import competition_create
from ..views.federations import (
    ...
    federation_manage_clubs, federation_remove_club, federation_settings, federation_export_data,
...
from ..views.dashboard.federations import federation_dashboard, federation_index
from competitions.views import federations
from competitions.views import federation_grades
from competitions.views import federation_clubs
