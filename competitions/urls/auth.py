...
from ..views.auth import signup_view, profile_view, password_change_view, login_view, logout_view
from ..views.debug_csrf_login import debug_login_view, test_login_no_csrf
