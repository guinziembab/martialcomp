...
def handle_coach_simplified(request):
    ...
    if request.method == 'POST':
        try:
            with transaction.atomic():
                ...
                if not created:
                    # Mettre à jour les infos si le pratiquant existe déjà
                ...
                # 2. Créer ou mettre à jour le profil coach
                ...
                if not created:
                    # Mettre à jour le profil s'il existe déjà
                ...
                if primary_discipline_id:
                    try:
                        ...
                        # Créer ou mettre à jour l'expertise pour la discipline principale
                        ...
                        if secondary_discipline_ids:
                            ...
                            for discipline_id in secondary_discipline_ids:
                                try:
                                    ...
                                    # Vérifier si cette expertise existe déjà
    ...
    context = {
        ...
        'federations': Federation.objects.all().order_by('name'),
