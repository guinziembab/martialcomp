...
def handle_final_setup(request):
    ...
    # Si l'utilisateur est déjà passé par le processus, rediriger vers le tableau de bord
    ...
    # Définir les indications pour chaque rôle
    next_steps = []
    ...
    if role == 'federation_admin':
        next_steps = [
            ...
            _("Invitez des clubs à rejoindre votre fédération.")
        ]
    elif role == 'club_manager':
        next_steps = [
            _("Configurez votre club en ajoutant plus de détails."),
            _("Inscrivez des membres à votre club."),
        ...
        next_steps = [
            _("Explorez les compétitions à venir."),
            _("Consultez les résultats des compétitions passées."),
            _("Suivez les clubs et athlètes qui vous intéressent.")
        ]
    
    # Récupérer le club ou la fédération associé à l'utilisateur
    club = None
    federation = None
