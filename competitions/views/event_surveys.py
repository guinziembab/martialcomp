...
from competitions.models.event import Event, EventSurvey, SurveyQuestion, SurveyResponse, QuestionResponse
...
# from competitions.forms.event_surveys import (
...
def survey_detail(request, survey_id):
    ...
    # Si l'utilisateur a déjà répondu et que les soumissions multiples ne sont pas autorisées
    if has_responded and not survey.allow_multiple_submissions:
        messages.info(request, _("Vous avez déjà répondu à ce sondage."))
...
def response_detail(request, response_id):
    """Affiche les détails d'une réponse à un sondage."""
