...
from competitions.models.competitions import Competition, CompetitionCategory
...
from competitions.utils.decorators import judge_required, competition_staff_required
from competitions.utils.scoring import ScoreCalculator, RankingGenerator
    ...
    try:
        ...
        return JsonResponse({
            'category': {
                ...
                'competition_name': category.competition.name,
            },
