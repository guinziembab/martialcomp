...
def calculate_category_results(request, competition_id, category_id):
    ...
    from competitions.views.management.scoring import calculate_results
...
def edit_ranking(request, competition_id, ranking_entry_id):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Mettre à jour le résultat de performance associé si existant
            ...
            messages.success(request, _("Le classement a été mis à jour avec succès."))
        except ValueError:
        ...
        with transaction.atomic():
            for ranking in CategoryRanking.objects.filter(competition=competition):
                for entry in RankingEntry.objects.filter(ranking=ranking):
                    ...
                    # Créer ou mettre à jour le résultat de compétition
...
def public_results_link(request, competition_id):
    ...
    from competitions.models import CompetitionShareToken
