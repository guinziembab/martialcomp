...
from competitions.models import Practitioner, Membership
...
from competitions.utils.finance_adapters import PaymentAdapter, AccountAdapter
...
def practitioner_payments(request):
    ...
    saved_payment_methods = []  # À implémenter avec un système de tokens
