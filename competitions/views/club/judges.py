...
from permissions_manager.decorators import permission_required
from permissions_manager.auth import user_has_permission
...
def judge_add(request):
    ...
    # Placeholder - à remplacer par la vraie logique d'ajout
    messages.info(request, _("Fonctionnalité d'ajout de juge à implémenter."))
