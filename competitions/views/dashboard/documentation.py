...
def dashboard_documentation(request, dashboard_type=None):
    ...
    Si dashboard_type est spécifié, affiche la documentation spécifique à ce type de dashboard.
    ...
    if not dashboard_type:
        ...
        dashboard_mapping = {
            ...
            'combat': 'combat',
            'admin': 'admin',  # À créer si nécessaire
            'spectator': 'spectators',  # À créer si nécessaire
        }
