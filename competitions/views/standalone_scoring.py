...
from competitions.models.standalone_scoring import (
...
from competitions.forms.standalone_scoring import (
    PerformanceForm,
    ScoringSystemForm,
...
from competitions.models.categories import CompetitionCategory as Category
from competitions.models.competitions import Competition
from competitions.models.judges import Judge
...
class StandaloneScoringDashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        recent_performances = StandalonePerformance.objects.all().order_by('-updated_at')[:10]
        ...
        category_configs = StandaloneCategoryScoringConfig.objects.all()[:10]
