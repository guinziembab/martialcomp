...
class Equipe(models.Model):
    """
    Équipe participant à une compétition de combat.
    """
    nom = models.CharField(_("Nom"), max_length=100)
...
class Poule(models.Model):
    ...
    PHASE_CHOICES = [
        ('eliminatoire', _('Éliminatoire')),
        ('quart', _('Quart de finale')),
        ('demi', _('Demi-finale')),
        ('finale', _('Finale')),
        ('repechage', _('Repêchage')),
    ]
...
class ActionCombat(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Surcharge de la méthode save pour mettre à jour le score du combat en fonction
        de l'action enregistrée.
        """
        super().save(*args, **kwargs)
        
        # Mettre à jour le score du combat
        combat = self.combat
