...
class Judge(models.Model):
    ...
    def upcoming_assignments(self):
        """Retourne les affectations à venir du juge."""
        today = timezone.now().date()
        return JudgeAssignment.objects.filter(
            registration__practitioner=self.practitioner,
...
class JudgeTechnicalApplication(models.Model):
    ...
    def approve(self, reviewer=None):
        ...
        with models.transaction.atomic():
            ...
            # Créer ou mettre à jour le profil de juge
...
class JudgeAssignment(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Si c'est un juge en chef, mettre à jour le champ correspondant
    ...
    def competition(self):
        """Retourne la compétition associée à cette affectation."""
