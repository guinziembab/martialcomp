...
class Competition(models.Model):
    ...
    organizing_organization = models.ForeignKey('organizations.Organization', 
        ...
        verbose_name=_("Organisation organisatrice")  # Corrigé de "Club organisateur" à "Organisation organisatrice"
    )
    ...
    discipline = models.ForeignKey(
        'Discipline',  # Utiliser une chaîne pour éviter les imports circulaires
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
