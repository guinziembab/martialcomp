...
# Modèle amélioré pour l'inscription des pratiquants à une compétition
class CompetitionRegistration(models.Model):
    # Utilisation de références avant (forward references) avec des chaînes
    ...
    # Rôles dans la compétition (multiple)
    ...
    class Meta:
        verbose_name = _("Inscription à une compétition")
...
class JudgeCompetitionAssignment(models.Model):
    ...
    class Meta:
        verbose_name = _("Affectation de juge à une compétition")
