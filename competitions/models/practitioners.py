...
class Practitioner(models.Model):
    ...
    # Nouveau champ faisant référence à l'application grades
    ...
    def current_grade(self):
        ...
        # Déléguer à l'application grades
        if self.grade:
            return self.grade
    ...
    def create_user_account(self):
        """
        Crée un compte utilisateur pour ce pratiquant s'il n'en a pas déjà un.
        Retourne un tuple (user, password, created) où created est un booléen indiquant si un nouvel utilisateur a été créé.
        """
        if self.user:
        ...
        # Définir le rôle de l'utilisateur comme participant
    ...
    def get_available_categories(self, competition):
        ...
        if current_grade:
            try:
                # Déléguer la vérification du grade à l'application grades
                from grades.utils import check_grade_eligibility
...
def get_current_grade_for_discipline(self, discipline):
    ...
    try:
        ...
        # Gérer le cas où discipline est un ID ou un objet
...
def get_all_current_grades(self):
    ...
    Returns:
        Un dictionnaire où les clés sont les IDs des disciplines et 
    ...
    try:
        ...
        # Récupérer tous les grades actuels en une seule requête
