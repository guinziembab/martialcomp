...
class ScoringSystem(models.Model):
    ...
    third_place_ties = models.BooleanField(
        ...
        default=True,
        help_text=_("Deux médailles de bronze peuvent être attribuées")
    )
...
class CategoryScoringConfig(models.Model):
    """Configuration de notation spécifique à une catégorie de compétition."""
    ...
    # Paramètres supplémentaires spécifiques à la catégorie
...
class Performance(models.Model):
    """Représente une performance qui doit être notée (passage d'un compétiteur)."""
    ...
    round_type = models.CharField(
        ...
        max_length=50, 
        blank=True,
        help_text=_("Ex: Éliminatoires, Quart de finale, Demi-finale, Finale")
    )
    ...
    def calculate_final_score(self):
        """Calculer le score final à partir des notes des juges."""
    ...
    def _calculate_standard_score(self, scores, system):
        """Calcul standard: moyenne pondérée avec exclusion des extrêmes."""
        total_scores = {}
        ...
        # Exclure les extrêmes si nécessaire
    ...
    def _calculate_point_score(self, scores, system):
        ...
        # À implémenter selon les règles de comptage de points spécifiques
        return None
    
    def _calculate_custom_score(self, scores, system):
        """Calcul personnalisé en fonction de la formule définie."""
        # À implémenter en utilisant la formule personnalisée du système
        return None
...
class Score(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Mettre à jour le score final de la performance
