...
class TrainingSlot(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Créneaux d'entraînement")
...
class TrainingSession(models.Model):
    """Session d'entraînement spécifique."""
    ...
    # Peut être différent du créneau habituel
    ...
    class Meta:
        verbose_name = _("Session d'entraînement")
        verbose_name_plural = _("Sessions d'entraînement")
...
class TrainingReservation(models.Model):
    """Réservation d'un pratiquant pour un entraînement."""
    ...
    class Meta:
        verbose_name = _("Réservation d'entraînement")
        verbose_name_plural = _("Réservations d'entraînement")
        ordering = ['-date', 'training_slot__start_time']
...
class Attendance(models.Model):
    """Présence aux sessions d'entraînement."""
...
class TrainingProgram(models.Model):
    ...
    class Meta:
        verbose_name = _("Programme d'entraînement")
        verbose_name_plural = _("Programmes d'entraînement")
        ordering = ['level', 'name']
...
class TrainingModule(models.Model):
    """Module d'un programme d'entraînement."""
...
class TrainingExercise(models.Model):
    """Exercice d'un module d'entraînement."""
...
class ProgramEnrollment(models.Model):
    """Inscription d'un pratiquant à un programme d'entraînement"""
