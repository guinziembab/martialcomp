...
class EventFeedback(models.Model):
    ...
    improvements = models.TextField(_("Points à améliorer"), blank=True)
    ...
    competition_fairness = models.PositiveSmallIntegerField(_("Équité de la compétition"), choices=[(i, str(i)) for i in range(1, 6)], null=True, blank=True)
