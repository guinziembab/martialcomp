...
def update_document_metadata(sender, instance, **kwargs):
    """Met à jour les métadonnées du document avant sauvegarde"""
    # Mise à jour de la taille du fichier si un nouveau fichier est uploadé
...
def update_children_paths(sender, instance, **kwargs):
    """Met à jour les chemins des sous-dossiers lorsqu'un dossier est modifié"""
