...
class EventNotificationForm(forms.Form):
    ...
    recipients = forms.ModelMultipleChoiceField(
        ...
        help_text=_("Sélectionnez les participants spécifiques à qui envoyer cette notification.")
    )
        ...
        if not send_immediately:
            ...
            if scheduled_date and scheduled_time:
                ...
                if scheduled_datetime <= timezone.now():
                    self.add_error('scheduled_date', _("La date et l'heure programmées doivent être dans le futur."))
    ...
    def save_notification(self):
        ...
        # Créer un objet de notification (à adapter selon votre modèle)
        from competitions.models.notifications import EventNotification
...
class EventInvitationForm(forms.Form):
    """
    Formulaire pour inviter des personnes à un événement.
    """
    ...
    emails = forms.CharField(
        ...
        help_text=_("Plusieurs adresses peuvent être séparées par des virgules ou des sauts de ligne.")
    )
    ...
    message = forms.CharField(
        ...
        help_text=_("Un message personnel à inclure dans l'invitation.")
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.event and self.event.organization:
            ...
            # Par exemple, si vous avez un modèle OrganizationGroup lié à Organization
            group_choices = [
    ...
    def send_invitations(self):
        ...
        from competitions.models.notifications import EventInvitation
