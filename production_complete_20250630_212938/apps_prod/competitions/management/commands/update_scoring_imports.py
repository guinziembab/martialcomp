...
class Command(BaseCommand):
    ...
    def process_file(self, file_path, dry_run, verbose):
        ...
        import_patterns = [
            r'from competitions.models.scoring import (.+)',
            r'from competitions.models.technical_scoring import (.+)',
            r'from competitions.models.scoring_criteria import (.+)',
            r'from competitions.models.scoring_results import (.+)',
        ]
        
        # Fix any incorrect user imports
        user_patterns = [
            r'from competitions.models.user import (.+)',
        ]
        ...
        for pattern in import_patterns:
            ...
            if matches:
                for match in matches:
                    ...
                    new_import = f'from competitions.models.scoring_compatibility import {match}'
        ...
        for pattern in user_patterns:
            ...
            if matches:
                for match in matches:
                    original_import = f'from competitions.models.user import {match}'
                    new_import = f'from competitions.models.users import {match}'
