#!/usr/bin/env python3
"""
Script de synchronisation automatique des disciplines de développement vers la production
Version automatique sans confirmation interactive
"""
...
def sync_disciplines():
    """Synchronise les disciplines automatiquement"""
    print("🔄 SYNCHRONISATION AUTOMATIQUE DES DISCIPLINES")
    print("=" * 60)
    ...
    # Exécuter les modifications automatiquement
