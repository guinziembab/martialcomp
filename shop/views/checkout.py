...
from shop.models import Cart, CartItem, Order, OrderItem, Address
...
def update_shipping_method(request):
    """
    API pour mettre à jour la méthode de livraison et recalculer les coûts.
    """
    if request.method != 'POST':
