...
class Address(models.Model):
    ...
    state_province = models.CharField(_("État/Province"), max_length=100, blank=True)
    ...
    def save(self, *args, **kwargs):
        # Si définie comme adresse par défaut, mettre à jour les autres adresses de l'utilisateur
