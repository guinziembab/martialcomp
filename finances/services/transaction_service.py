...
class TransactionService:
    ...
    def validate_transaction(transaction_id, user, notes=None):
        ...
        Args:
            transaction_id (str): L'ID de la transaction à valider
        ...
        if transaction.status != 'pending':
            raise ValidationError(_('Seules les transactions en attente peuvent être validées'))
        ...
        with db_transaction.atomic():
            # Si la transaction est liée à un compte, mettre à jour le solde
    ...
    def reject_transaction(transaction_id, user, reason=None):
        ...
        Args:
            transaction_id (str): L'ID de la transaction à rejeter
        ...
        if transaction.status != 'pending':
            raise ValidationError(_('Seules les transactions en attente peuvent être rejetées'))
    ...
    def cancel_transaction(transaction_id, user, reason=None):
        ...
        Args:
            transaction_id (str): L'ID de la transaction à annuler
        ...
        if transaction.status not in ['validated', 'pending']:
            raise ValidationError(_('Seules les transactions validées ou en attente peuvent être annulées'))
