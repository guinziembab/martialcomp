"""
Vues spécifiques à l'intégration multi-tenant du module finances.
"""
...
from multitenant.mixins import TenantAwareViewMixin, TenantRequiredMixin
from multitenant.models import Tenant
from multitenant.performance_mixins import TenantCacheMixin, TenantDashboardMixin
from finances.tenant_integration import tenant_finance_required
from finances.models.accounts import Account, AccountType
from finances.models.invoices import Invoice, InvoiceItem
from finances.models.payments import Payment
from finances.models.transactions import Transaction, TransactionType
from finances.tenant_models import (
    TenantFinancialSetting, TenantBillingCycle, 
    TenantInvoiceTemplate
)
from finances.forms.accounts_forms import AccountForm
from finances.forms.invoice_forms import InvoiceForm, InvoiceItemFormSet
...
class TenantSettingsUpdateView(LoginRequiredMixin, TenantRequiredMixin,
    ...
    """
    Mise à jour des paramètres financiers du tenant.
    """
    ...
    def get_form(self, form_class=None):
        ...
        # Limiter les choix de comptes à ceux du tenant
    ...
    def form_valid(self, form):
        messages.success(self.request, _("Les paramètres financiers ont été mis à jour."))
