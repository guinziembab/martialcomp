...
class Invoice(models.Model):
    """
    Modèle représentant une facture émise par une entité (club, fédération) à un destinataire.
    """
    STATUS_CHOICES = [
        ('draft', _('Brouillon')),
        ('issued', _('Émise')),
    ...
    # Relations
    # Émetteur de la facture (club, fédération, etc.)
    ...
    # Entité liée à la facture (compétition, adhésion, etc.)
    ...
    def save(self, *args, **kwargs):
        ...
        # Calculer/mettre à jour les montants
        if not self.total:
    ...
    def issue(self):
        """
        Émet la facture (passe du statut brouillon à émise).
        """
