...
from finances.models import PaymentMethod, PaymentAttempt, Transaction


class PaymentMethodForm(forms.ModelForm):
    """
    Formulaire pour créer ou mettre à jour une méthode de paiement.
    """
    ...
    def clean(self):
        ...
        try:
            ...
            self.add_error('config', _("La configuration doit être un JSON valide."))
...
class PaymentProcessForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if transaction:
            ...
            # Ajouter le montant à payer en lecture seule
