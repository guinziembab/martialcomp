...
try:
    ...
    # Si le fichier pricing.py n'existe pas, créer des modèles temporaires
...
try:
    from .subscription import FeatureFlag, OrganizationSubscription, FeatureUsageLog
except ImportError:
    # Si le fichier subscription.py n'existe pas, créer des modèles temporaires
    from django.db import models
