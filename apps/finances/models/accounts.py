...
class FinancialAccount(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Si c'est marqué comme compte par défaut, désactiver ce flag pour les autres comptes du mÃªme propriétaire
    ...
    def update_balance(self, amount, transaction_type):
        """
        Met Ã  jour le solde du compte basé sur une transaction.
        
        Parameters:
        - amount: le montant Ã  ajouter ou soustraire
...
class MembershipFee(models.Model):
    ...
    grace_period_days = models.PositiveIntegerField(default=30, verbose_name=_('Période de grÃ¢ce (jours)'))
    ...
    age_min = models.PositiveIntegerField(null=True, blank=True, verbose_name=_('Ã‚ge minimum'))
    age_max = models.PositiveIntegerField(null=True, blank=True, verbose_name=_('Ã‚ge maximum'))
