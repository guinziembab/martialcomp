...
class Transaction(models.Model):
    ...
    # Date de la transaction (peut Ãªtre différente de la date de création)
    ...
    date_updated = models.DateTimeField(auto_now=True, verbose_name=_('Date de mise Ã  jour'))
    ...
    # Relations avec d'autres modèles (Ã  activer lorsque ces modèles seront créés)
    # Notez que ces relations utiliseront des chaÃ®nes pour éviter les dépendances circulaires
    ...
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='updated_transactions', verbose_name=_('Mis Ã  jour par'))
    ...
    def save(self, *args, **kwargs):
        ...
        # Mettre Ã  jour la date de validation si le statut change Ã  'validated'
...
class TransactionAttachment(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # Déterminer le type de fichier Ã  partir de l'extension
