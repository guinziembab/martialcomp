...
def get_financial_permissions(user):
    ...
    # Vérifier si l'utilisateur a un rÃ´le spécifique
    is_admin_role = False
    user_role = None
    ...
    perms = {
        ...
        'can_add_transactions': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_validate_transactions': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_view_all_transactions': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_view_invoices': True,
        'can_create_invoices': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_view_all_invoices': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_process_payment': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_view_reports': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_view_accounts': is_admin_role,  # Autorisé pour les rÃ´les administratifs
        'can_manage_accounts': True,  # Autorisé temporairement pour tous les utilisateurs connectés
        'can_manage_memberships': True,  # Autorisé temporairement pour tous les utilisateurs connectés
    ...
    if user.has_perm('finances.change_membershipfee'):
        perms['can_manage_memberships'] = True
    ...
    # Vérifier si l'utilisateur a un rÃ´le spécifique dans le système
    # Cela dépendra de l'implémentation des rÃ´les dans votre application
...
def render_to_pdf(template_src, context_dict=None):
    """
    Génère un PDF Ã  partir d'un template HTML et d'un contexte.
