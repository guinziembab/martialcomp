...
Centralise tous les événements familiaux, compétitions, entraÃ®nements, etc.
"""
...
from apps.competitions.models import Competition, Event, Practitioner
...
class FamilyCalendarService:
    ...
    def get_consolidated_calendar(self, start_date=None, end_date=None, member_filters=None):
        ...
        Args:
            ...
            member_filters (list): IDs des membres Ã  inclure (défaut: tous)
    ...
    def _get_training_events(self, start_date, end_date, member_filters=None):
        """Récupère les entraÃ®nements des membres de la famille."""
        if not TRAINING_AVAILABLE:
            return []
        
        # Cette implémentation dépend de l'existence du modèle TrainingSession
        # Ã€ adapter selon la structure réelle des entraÃ®nements dans MartialComp
        training_events = []
        
        # Logique de récupération des entraÃ®nements Ã  implémenter
    ...
    def _generate_month_view(self, start_date, events_by_date):
        ...
        while True:
            ...
            # ArrÃªter si on a dépassé la période demandée
    ...
    def _find_common_free_periods(self, availability, duration_minutes):
        """Trouve les créneaux libres communs Ã  tous les membres."""
