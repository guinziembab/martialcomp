...
def update_practitioner_grade(sender, instance, created, **kwargs):
    """Met Ã  jour le grade affiché sur le profil du pratiquant lorsqu'un nouveau grade lui est attribué."""
    if instance.is_current:
        # Mettre Ã  jour le champ grade du pratiquant si ce grade est le grade actuel
...
def handle_deleted_grade(sender, instance, **kwargs):
    """
    Met Ã  jour le grade du pratiquant lorsqu'un grade est supprimé.
    ...
    if instance.is_current:
        ...
        if latest_grade:
            ...
            # Mettre Ã  jour le grade affiché sur le profil du pratiquant
...
def handle_exam_registration_status_change(sender, instance, created, **kwargs):
    """
    Gère les changements de statut d'inscription Ã  un examen.
    Si le statut passe Ã  'passed', attribue automatiquement le grade au pratiquant.
    """
