...
class GradeListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['categories'] = get_organization_queryset(GradeCategory, self.request.user)
...
class GradeRequirementListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['disciplines'] = get_organization_queryset(Discipline, self.request.user)
        context['grades'] = get_organization_queryset(Grade, self.request.user)
...
def export_grades(request):
    ...
    # Construire la requ̻te
    queryset = get_organization_queryset(Grade, self.request.user)
