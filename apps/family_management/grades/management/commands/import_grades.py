    ...
    def import_grade_system(self):
        ...
        all_grades = {
            'grades': [
                ...
                {"id": 38, "name": "Ã‰charpe Bleue", "discipline": "Qwan Ki Do", "category": "Cap Bleu (Juniors/Adultes)", "color": "Bleu", "color_code": "#2196F3", "level": 17, "min_age": 13},
        ...
        # Compter les éléments créés/mis Ã  jour
        grades_created = 0
        grades_updated = 0
        ...
        for grade_data in all_grades['grades']:
            ...
            if created:
                ...
                grades_updated += 1
                self.stdout.write(self.style.SUCCESS(f'Grade mis Ã  jour: {grade.name} ({discipline_name})'))
        ...
        self.stdout.write(self.style.SUCCESS(f'- Grades mis Ã  jour: {grades_updated}'))
