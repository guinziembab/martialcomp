...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': "Fonctionnalité Ã\xa0 l'usage",
                'verbose_name_plural': "Fonctionnalités Ã\xa0 l'usage",
                'ordering': ['name'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_from', models.DateTimeField(verbose_name='Valide Ã\xa0 partir de')),
                ('valid_until', models.DateTimeField(verbose_name="Valide jusqu'Ã\xa0")),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['tenant', 'status'], name='multitenant_tenant__ce6f7e_idx'), models.Index(fields=['provider_payment_id'], name='multitenant_provide_3fd7ea_idx'), models.Index(fields=['created_at'], name='multitenant_created_12fcae_idx')],
            },
        ),
        migrations.CreateModel(
            name='TenantFeature',
            fields=[
                ...
                ('enabled_until', models.DateTimeField(blank=True, help_text='Pour les fonctionnalités temporaires', null=True, verbose_name="Activé jusqu'Ã\xa0")),
                ('metadata', models.JSONField(default=dict, help_text='Configuration spécifique Ã\xa0 la fonctionnalité', verbose_name='Métadonnées')),
