...
from apps.multitenant.middleware import _thread_local
...
class TenantMiddleware(MiddlewareMixin):
    ...
    Ce middleware:
    1. Identifie le tenant Ã  partir du domaine de la requÃªte
    ...
    def process_request(self, request):
        """
        Traite chaque requÃªte pour identifier le tenant.
        """
        ...
        # Obtenir le hostname depuis la requÃªte
        ...
        # Stocker le tenant dans la requÃªte et le contexte thread-local
    ...
    def process_response(self, request, response):
        """
        Réinitialise le schéma après chaque requÃªte.
        """
...
class TenantContext:
    ...
    def __enter__(self):
        from apps.multitenant.middleware import get_current_tenant
        from apps.multitenant.schema_utils import get_current_schema, set_schema
