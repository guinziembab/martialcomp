...
class Cart(models.Model):
    ...
    def add_item(self, product, quantity=1, variation=None):
        """
        Ajoute un article au panier ou met Ã  jour sa quantité si déjÃ  présent.
        """
    ...
    def update_item_quantity(self, cart_item_id, quantity):
        """
        Met Ã  jour la quantité d'un article du panier.
        """
        try:
    ...
    def get_discount(self):
        ...
        """
        # Ã€ implémenter avec le système de promotions
        return Decimal('0.00')
