...
class Permission(models.Model):
    ...
    class Meta:
        app_label = 'permissions_manager'
        verbose_name = _("Permission")
        verbose_name_plural = _("Permissions")
        ordering = ['category', 'code']

class Role(models.Model):
    """Ensemble de permissions formant un rÃ´le"""
    ...
    is_system_role = models.BooleanField(_("RÃ´le système"), default=False,
        help_text=_("Les rÃ´les système ne peuvent pas Ãªtre modifiés par les utilisateurs"))
    ...
    class Meta:
        app_label = 'permissions_manager'
        verbose_name = _("RÃ´le")
        verbose_name_plural = _("RÃ´les")
        ordering = ['context_type', 'name']

class UserRoleAssignment(models.Model):
    """Attribution d'un rÃ´le Ã  un utilisateur dans un contexte spécifique"""
    ...
    class Meta:
        app_label = 'permissions_manager'
        verbose_name = _("Attribution de rÃ´le")
        verbose_name_plural = _("Attributions de rÃ´les")
        ordering = ['-created_at']
        constraints = [
