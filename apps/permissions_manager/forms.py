...
class RoleForm(forms.ModelForm):
    """Formulaire pour la création et modification de rÃ´les"""
    class Meta:
        model = Role
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Seuls les superutilisateurs peuvent créer des rÃ´les système
...
class UserRoleAssignmentForm(forms.ModelForm):
    """Formulaire pour l'attribution de rÃ´les aux utilisateurs"""
    context_type = forms.ChoiceField(
        choices=[('', '-- Sélectionnez un type --')],
        required=False,
        label=_("Type de contexte"),
        help_text=_("Laissez vide pour un rÃ´le global")
    )
