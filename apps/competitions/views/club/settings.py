...
from apps.competitions.models.club_requests import AffiliationRequest
    ...
    if request.method == 'POST':
        ...
        if federation_id:
            ...
            if existing_request:
                ...
                messages.success(request, _("Votre demande d'affiliation à {} a été envoyée.").format(federation.name))
