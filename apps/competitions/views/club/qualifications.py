...
from apps.competitions.models import Practitioner, Club, JudgeQualification
from apps.competitions.forms.qualification import PractitionerGradeForm
    ...
    try:
        ...
        messages.warning(
            ...
            _("Le module de qualification des juges n'est pas disponible. "
             "Affichage des pratiquants qui semblent Ãªtre des juges ou arbitres selon leur grade.")
        )
    except Exception as e:
        # Erreur générique
    ...
    if not judges:
        ...
        messages.info(
            ...
            _("Aucun juge ou arbitre n'a été trouvé dans votre club. "
              "Vous pouvez ajouter des qualifications Ã  vos pratiquants depuis leur profil.")
        )
...
def delete_qualification(request, qualification_id):
    ...
    try:
        ...
        # Vérifier que la qualification appartient bien Ã  un pratiquant du club
