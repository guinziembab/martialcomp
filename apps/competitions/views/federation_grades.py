...
from apps.grades.forms import GradeCategoryForm  # Ajustez selon votre structure réelle
        ...
        try:
            ...
            try:
                ...
                if not discipline_grades:
                    ...
                    from apps.grades.views.api import get_default_grades_for_discipline
