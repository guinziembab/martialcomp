...
from apps.competitions.models.users import User  # Si vous avez un fichier users.py
# OU
from django.contrib.auth import get_user_model
User = get_user_model()  # Cette approche est plus sûre et universelle
from apps.competitions.forms.auth import UserRegistrationForm  # Ajustez cette importation selon vos formulaires
