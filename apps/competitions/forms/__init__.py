...
# Définir la liste des formulaires disponibles Ã  l'importation
__all__ = []
...
from .trainings import JudgeTrainingForm  # Changé de ".training" Ã  ".trainings"
...
from .practitioner import (
    ...
    TrainingReservationForm  # Formulaire de réservation d'entraÃ®nement
)
...
# Ajouter les formulaires importés Ã  __all__
__all__.extend([
    # Formulaires de base
    'CompetitionForm',
