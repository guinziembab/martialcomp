...
class EventSurveyForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Limiter les événements disponibles Ã  ceux créés par l'utilisateur
        # ou dans les organisations oÃ¹ il est admin/manager
        if user:
...
class SurveyQuestionForm(forms.ModelForm):
    ...
    choices_text = forms.CharField(
        ...
        required=False,
        help_text=_("Pour les questions Ã  choix, entrez une option par ligne.")
    )
    ...
    def clean(self):
        ...
        if question_type in ['single_choice', 'multiple_choice']:
            if not choices_text:
                self.add_error('choices_text', _("Veuillez fournir des options pour cette question Ã  choix."))
        ...
        if question_type in ['rating', 'scale']:
            ...
            if min_value is not None and max_value is not None and min_value >= max_value:
                self.add_error('max_value', _("La valeur maximale doit Ãªtre supérieure Ã  la valeur minimale."))
...
class BaseSurveyQuestionFormSet(BaseInlineFormSet):
    ...
    def clean(self):
        ...
        for form in self.forms:
            ...
            if order in orders:
                form.add_error('order', _("Ce numéro d'ordre est déjÃ  utilisé."))
            orders[order] = True
...
class SurveyResponseForm(forms.Form):
    """Formulaire dynamique pour répondre Ã  un sondage."""
    ...
    def clean(self):
        ...
        # Si le sondage est anonyme, l'utilisateur ne peut pas Ãªtre identifié
    ...
    def save(self):
        ...
        for question in questions:
            ...
            if field_name in self.cleaned_data:
                ...
                # Créer l'instance de réponse Ã  la question
