...
from apps.competitions.views import categories
...
urlpatterns = [
    ...
    # Les méthodes edit et delete pour les templates ne semblent pas Ãªtre implémentées dans views/categories.py
    # mais je les laisse pour cohérence avec la structure, Ã  implémenter si nécessaire
