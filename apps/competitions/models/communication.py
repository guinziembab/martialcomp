...
class ConversationParticipant(models.Model):
    """Participant Ã  une conversation."""
...
class Message(models.Model):
    ...
    reply_to = models.ForeignKey(
        ...
        verbose_name=_("Réponse Ã ")
    )
    
    # Métadonnées
    is_edited = models.BooleanField(_("Ã‰dité"), default=False)
    edited_at = models.DateTimeField(_("Ã‰dité le"), null=True, blank=True)
