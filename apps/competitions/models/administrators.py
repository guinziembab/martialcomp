...
def create_federation_admin_association(sender, instance, created, **kwargs):
    ...
    try:
        ...
        if instance.role == 'federation_admin':
            # Vérifier s'il existe déjÃ  une association administrateur-fédération
            ...
            if not admin_roles.exists():
                with transaction.atomic():
                    # 1. Vérifier si l'utilisateur possède déjÃ  une fédération
                    ...
                    if owned_federations.exists():
                        ...
                        try:
                            ...
                            if organization:
                                # Mettre Ã  jour avec l'organization correspondante
                        ...
                        # Chercher une fédération récente qui pourrait correspondre Ã  cet utilisateur
                        found_match = False
    ...
    if created and hasattr(instance, 'owner') and instance.owner:
        try:
            with transaction.atomic():
                ...
                # Mise Ã  jour du profil utilisateur si nécessaire
