...
class OrganizationQRCode(models.Model):
    """
    Code QR unique associé Ã  une organisation (club, fédération, coach).
    ...
    club = models.ForeignKey(
        ...
        related_name='organization_qr_codes',
        verbose_name=_("Club"),
    ...
    def record_scan(self, user=None, ip_address=None, user_agent=None, location=None):
        """Enregistre un scan et met Ã  jour les statistiques."""
        self.scan_count += 1
    ...
    def generate_qr_code(self):
        ...
        # Mettre Ã  jour l'URL et l'image
        self.url = url
...
class OrganizationQRCodeScan(models.Model):
    ...
    location = models.CharField(
        ...
        verbose_name=_("Lieu"),
        help_text=_("Lieu oÃ¹ le scan a été effectué")
    )
    ...
    user_created = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='organization_qr_registrations',
    ...
    def mark_converted(self, conversion_type='registration', user=None, practitioner=None, payment_amount=None, transaction=None):
        ...
        # Mettre Ã  jour les statistiques du QR code
...
class ReferralLink(models.Model):
    ...
    def use(self):
        """Utilise le lien de parrainage et met Ã  jour le compteur."""
        if self.is_valid():
            self.current_uses += 1
    ...
    def get_discount_info(self):
        ...
        if self.discount_amount:
            return {
                ...
                'formatted': f"{self.discount_amount} â‚¬"
            }
...
class ReferralUse(models.Model):
    ...
    def mark_payment_completed(self, transaction=None, discount_amount=None):
        ...
        # Mettre Ã  jour le lien de parrainage
        self.referral_link.use()
        
        # Notifier le parrain qu'il a droit Ã  une réduction
        self.notify_referrer()
    
    def notify_referrer(self):
        """Notifie le parrain qu'il a droit Ã  une réduction."""
