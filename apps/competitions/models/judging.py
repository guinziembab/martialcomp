...
class JudgeAssignment(models.Model):
    """Assignation d'un juge Ã  une catégorie de compétition."""
...
class JudgeAvailability(models.Model):
    ...
    preferred_roles = models.CharField(
        ...
        max_length=255, 
        blank=True,
        help_text=_("RÃ´les préférés séparés par des virgules: chief,technical,combat,assistant")
    )
...
class JudgeApplication(models.Model):
    ...
    def approve(self, reviewer):
        ...
        with models.transaction.atomic():
            ...
            # Créer/mettre Ã  jour le profil de juge
