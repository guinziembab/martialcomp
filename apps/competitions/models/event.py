...
class Event(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("Ã‰vénements")
    ...
    def is_upcoming(self):
        """Vérifie si l'événement est Ã  venir."""
    ...
    def is_user_registered(self, user):
        """Vérifie si un utilisateur est inscrit Ã  cet événement."""
...
class EventParticipant(models.Model):
    ...
    class Meta:
        app_label = 'competitions'
        verbose_name = _("Participant Ã  l'événement")
...
class SurveyQuestion(models.Model):
    ...
    # Options pour les questions Ã  choix
...
class QuestionResponse(models.Model):
    ...
    choice_response = models.JSONField(_("Réponse Ã  choix"), default=list, blank=True)
    ...
    def __str__(self):
        return f"Réponse Ã  {self.question}"
