...
Ce système remplace/étend ClubAdministrator et FederationAdministrator
pour une gestion unifiée et plus granulaire des permissions.
"""
...
class ClubMember(models.Model):
    ...
    role_assigned_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='club_role_assignments_made',
...
class FederationMember(models.Model):
    ...
    role_assigned_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name='federation_role_assignments_made'
    )
    notes = models.TextField(_("Notes"), blank=True)
...
class MemberRoleHistory(models.Model):
    ...
    performed_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True,
        related_name='member_role_changes_made'
    )
