...
class OrganizationScopedModel(models.Model):
    ...
    Tous les modèles contenant des données spécifiques Ã  une organisation doivent hériter de cette classe.
    """
    ...
    organization = models.ForeignKey(
        ...
        help_text=_("L'organisation Ã  laquelle appartient cet élément")
    )
    ...
    def is_accessible_by(self, user):
        """
        Vérifie si l'utilisateur a accès Ã  cette ressource.
    ...
    def check_access(self, user):
        ...
        if not self.is_accessible_by(user):
            raise PermissionDenied(
                _("Vous n'avez pas accès Ã  cette ressource")
            )
...
class FederationScopedModel(models.Model):
    ...
    federation = models.ForeignKey(
        ...
        help_text=_("La fédération Ã  laquelle appartient cet élément")
    )
...
class OrganizationScopedManager(models.Manager):
    ...
    def for_organization(self, organization):
        ...
        Args:
            organization: L'organisation Ã  filtrer
...
class FederationScopedManager(models.Manager):
    ...
    def for_federation(self, federation):
        ...
        Args:
            federation: La fédération Ã  filtrer
...
class SharedResourceModel(models.Model):
    """
    Classe abstraite pour les ressources pouvant Ãªtre partagées entre organisations.
    """
