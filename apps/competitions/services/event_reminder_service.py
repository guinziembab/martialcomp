...
class ReminderService:
    ...
    def get_due_reminders():
        """
        Récupère tous les rappels dont l'envoi est dÃ».
        
        Un rappel est considéré comme dÃ» lorsque :
        - Il est activé
    ...
    def send_reminder(reminder):
        ...
        try:
            ...
            return {
                "success": True, 
                "message": f"Rappel envoyé avec succès Ã  {delivery_status['sent']} destinataires. "
    ...
    def _send_email_reminder(reminder, recipient, context):
        ...
        try:
            ...
            # Ajouter des pièces jointes si nécessaire (Ã  implémenter si besoin)
    ...
    def _send_sms_reminder(reminder, recipient, context):
        ...
        Cette fonction est un exemple et devrait Ãªtre adaptée selon le fournisseur choisi.
        """
        try:
            ...
            if len(sms_content) > 160:
                # Limiter Ã  160 caractères pour un SMS standard
            ...
            logger.info(f"Simulé: SMS envoyé Ã  {phone_number} - Contenu: {sms_content}")
            return True
    ...
    def _send_notification_reminder(reminder, recipient, context):
        ...
        Cette fonction dépend d'un système de notification qui devrait Ãªtre
    ...
    def process_all_due_reminders():
        """
        Traite tous les rappels dont l'envoi est dÃ».
        
        Cette fonction est destinée Ã  Ãªtre appelée par un job planifié
        (par exemple via Celery ou une tÃ¢che cron).
    ...
    def create_email_template(path='competitions/emails/event_reminder.html'):
        ...
        Cette fonction est utilitaire et n'est pas destinée Ã  Ãªtre appelée en production.
        """
        import os
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="event-details">
                ...
                {% if event.start_time %} {% translate "Ã " %} {{ event.start_time|time:"H:i" }}{% endif %}
                {% if event.end_date and event.end_date != event.start_date %}
                    {% translate "au" %} {{ event.end_date|date:"d/m/Y" }}
                {% endif %}
                {% if event.end_time %} {% translate "jusqu'Ã " %} {{ event.end_time|time:"H:i" }}{% endif %}
                </p>
...
def send_specific_reminder(reminder_id):
    """
    Fonction pour envoyer un rappel spécifique, Ã  appeler depuis un job scheduler.
    """
    try:
