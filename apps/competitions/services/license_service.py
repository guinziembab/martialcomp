# apps/competitions/services/license_service.py
"""
Service for generating license numbers for practitioners.
Moved from apps/competitions/services.py to consolidate in services package.
"""
...
class LicenseNumberGenerator:
    ...
    @classmethod
    def generate(cls, practitioner=None, discipline=None, club=None, birth_date=None,
                 discipline_id=None, club_id=None):
        from apps.competitions.models import Discipline as D, Club as C
