...
from apps.competitions.views.club import (
...
# Import des vues d'entraÃ®nement
...
from apps.competitions.views.club.profiles import (
    user_profile, practitioner_profile, update_practitioner_profile
)

# Vues des qualifications
from apps.competitions.views.club.qualifications import qualification_form
...
from apps.competitions.views.club import (
    ...
    judge_add,
    judge_assignments,
    #technical_scoring,  # Commenté Ã  cause de l'erreur BACH HAC
    competition_scoring, 
    performance_detail,
...
from apps.competitions.views.club.technical_scoring_hotfix import technical_scoring_hotfix

# Import des modules résultats
from apps.competitions.views.club import results

# Import du module de paramètres du club
from apps.competitions.views.club import settings

# Import des vues de gestion des rÃ´les
...
urlpatterns = [
    ...
    # =========================================================
    # URLs de gestion des rÃ´les et permissions
    # =========================================================
