...
from apps.competitions.models import Discipline, CompetitionType
    ...
    def handle(self, *args, **kwargs):
        ...
        disciplines_and_types = {
            'Qwan Ki Do': [
                ...
                'Techniques traditionnelles "Song Luyen" Ã  deux',
                'Co Vo Dao - Techniques individuelles armes traditionnelles',
                'Co Vo Dao - Techniques armes traditionnelles "Song Luyen" Ã  deux',
        ...
        for discipline_name, competition_types in disciplines_and_types.items():
            ...
            for i, comp_type in enumerate(competition_types):
                # Vérifier si le type existe déjÃ 
        ...
        self.stdout.write(self.style.SUCCESS(
            f'Terminé ! {created_count} types de compétition créés, {existing_count} déjÃ  existants.'
        ))
