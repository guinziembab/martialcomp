# competitions/middleware/organizational_context.py
"""
...
def get_club_membership(request):
    ...
    try:
        ...
        # Fallback sur ClubAdministrator existant pour la période de transition
...
class OrganizationalContextMiddleware(MiddlewareMixin):
    ...
    Configuration dans settings.py:
        MIDDLEWARE = [
            ...
            'apps.competitions.middleware.organizational_context.OrganizationalContextMiddleware',
        ]
...
class AutoClubSelectionMiddleware(MiddlewareMixin):
    ...
    def process_request(self, request):
        ...
        from apps.competitions.models import ClubMember, ClubAdministrator
