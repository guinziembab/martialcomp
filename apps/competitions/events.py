...
from apps.competitions.views import events
...
urlpatterns = [
    ...
    path('planning/', include('competitions.event_planning', namespace='planning')),
    
    # Event surveys
    path('surveys/', include('competitions.event_surveys', namespace='surveys')),
]
