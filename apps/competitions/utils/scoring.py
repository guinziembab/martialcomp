...
class ScoreCalculator:
    ...
    def _calculate_standard_score(self):
        ...
        from apps.competitions.models.unified_scoring import Score, ScoringCriterion
    ...
    def _calculate_point_score(self):
        ...
        """
        # Import here to avoid circular imports
        from apps.competitions.models.unified_scoring import Score
...
class RankingGenerator:
    ...
    def generate_rankings(self):
        ...
        """
        # Import here to avoid circular imports
        from apps.competitions.models.unified_scoring import Performance, CompetitionRanking
    ...
    def handle_third_place_tie(self):
        ...
        """
        # Import here to avoid circular imports
        from apps.competitions.models.unified_scoring import CompetitionRanking
    ...
    def create_snapshot(self, user=None, name='', notes='', publish=False):
        ...
        """
        # Import here to avoid circular imports
        from apps.competitions.models.unified_scoring import CategoryRankingSnapshot
