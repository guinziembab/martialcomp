...
### 2. Système de parrainage pour fédérations

#### 2.1 Paramètres clés
- Commission unique de parrainage: 7% du premier paiement annuel du club
- Versement unique lors de l'inscription initiale du club (non récurrent)
...
- Création des modèles `Wallet`, `Transaction` et `ReferralCommission`
- Extension du modèle `Affiliation` avec le champ `referral_commission_percentage`
- Système de calcul automatique de la commission unique lors du premier paiement
- Interface de gestion du portefeuille et historique des parrainages pour les fédérations
...
class ReferralCommission(models.Model):
    # Commission unique générée par le parrainage d'un club
...
#### 2.4 Processus de parrainage
1. Une fédération invite un club via l'interface MartialComp (lien unique)
2. Le club s'inscrit en utilisant ce lien de parrainage
3. Lors du premier paiement du club, la commission est calculée automatiquement
4. La fédération reçoit une notification et le montant est crédité dans son portefeuille
5. La relation de parrainage est enregistrée de façon permanente pour référence future
...
### 2. Mesures d'incitation au parrainage
- Bonus de 50€ dans le portefeuille des fédérations pour chaque club parrainé
- Programme "Champion du parrainage" avec badges et reconnaissance pour les fédérations actives
- Outil de suivi des clubs parrainés et des commissions générées
- Ressources marketing personnalisables pour les fédérations
