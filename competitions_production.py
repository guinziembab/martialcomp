...
def competition_create(request, federation_id=None):
    ...
    # Récupérer federation_id depuis le paramètre ou la query string
...
def competition_detail_public(request, pk):
    """Vue publique simplifiée pour les détails d une compétition"""
