...
class PermissionsMiddleware(MiddlewareMixin):
    ...
    Ce middleware peut être utilisé pour définir des règles de permissions
    basées sur les patterns d'URL plutôt que sur les vues individuelles.
    """
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        # Vérifier si une règle s'applique à cette URL
        if url_name in self.url_permission_rules:
            ...
            context = None
            # Logique pour déterminer le contexte à partir de l'URL
