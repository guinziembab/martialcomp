...
def user_has_permission(user, permission_code, context=None):
    ...
    Args:
        ...
        permission_code: Le code de la permission à vérifier
...
def get_user_permissions(user, context=None):
    ...
    # Récupérer toutes les permissions associées à ces rôles
...
def get_user_roles(user, context=None):
    """
    Retourne tous les rôles d'un utilisateur dans un contexte donné
