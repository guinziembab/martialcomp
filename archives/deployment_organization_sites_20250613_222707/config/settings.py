...
CSRF_COOKIE_SECURE = False    # Pour le développement, mettre True en production
...
PAYMENT_PROVIDERS = {
    ...
    'paystack': {
        'api_key': 'sk_test_your_paystack_key',
        'webhook_secret': 'your_paystack_webhook_secret',
        'public_key': 'pk_test_your_public_key',
    },
    'mercadopago': {
        'access_token': 'TEST-your_mercadopago_token',
        'public_key': 'TEST-your_mercadopago_public_key',
    },
    'alipay': {
...
INSTALLED_APPS = [
    # Modeltranslation doit être placé avant admin pour l'intégration
    'modeltranslation',
    ...
    # Django-allauth pour l'authentification sociale
    'allauth',
    'allauth.account',
...
MIDDLEWARE = [
    ...
    # 'competitions.middleware.OnboardingMiddleware',  # Désactivé temporairement pour le dev
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'competitions.context_processors.federation_sidebar_context',
...
# Base URL pour l'application (utilisé par les générateurs QR et autres)
BASE_URL = os.environ.get('BASE_URL', 'http://localhost:8000')
TENANT_BASE_DOMAIN = os.environ.get('TENANT_BASE_DOMAIN', 'martialcomp.com')
...
# Configuration du site pour django-allauth
SITE_ID = 1
...
# Configuration de la redirection après authentification sociale
SIGNUP_REDIRECT_URL = '/onboarding/role/'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'finance_audit': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs', 'finance_audit.log'),
            'formatter': 'audit',
        },
        'security_file': {
            'level': 'INFO',
    ...
    'loggers': {
        ...
        'finances': {
            'handlers': ['console', 'file', 'finance_audit'],
            'level': 'INFO',
            'propagate': True,
        },
        'security': {
...
# Si nous sommes en mode production
if not DEBUG:
...
# Configuration Stripe (à adapter selon l'environnement)
