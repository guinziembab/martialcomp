...
from competitions.views.auth import signup_view, logout_view, login_view, profile_view, password_change_view
...
from competitions.views.translation_dashboard import translation_dashboard, translation_stats_api

# Import pour les URLs des sites d'organisations
from competitions.urls.organization_sites import admin_urlpatterns
...
urlpatterns = [
    ...
    path('admin/translations/dashboard/', translation_dashboard, name='translation_dashboard'),
    path('admin/translations/stats/', translation_stats_api, name='translation_stats_api'),
...
urlpatterns += i18n_patterns(
    ...
    # URLs d'authentification et profil
    path('auth/', include(('competitions.urls.auth', 'competitions'), namespace='auth')),
    
    # URLs de profil directes (raccourcis)
    ...
    # Routes d'authentification allauth (remplace django.contrib.auth.urls)
...
# Ajouter les URLs d'administration des sites d'organisations
urlpatterns += admin_urlpatterns

# Ajouter les URLs des sites d'organisations (pour sous-domaines)
# Ces URLs sont actives seulement si un tenant est détecté
urlpatterns += [
