...
from apps.competitions.models import Practitioner, Club, CategoryGrade  # Ajout de CategoryGrade

# Importation de notre helper de permission personnalisé
from apps.competitions.utils.permission_helpers import manual_permission_check, get_user_club as get_user_club_from_helper
    ...
    if request.method == 'POST':
        try:
            ...
            if category_type == 'age':
                ...
                # club.categories.add(category)  # Ã€ adapter selon votre modèle
