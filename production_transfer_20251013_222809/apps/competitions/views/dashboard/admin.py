        ...
        # Si c'est un admin de fédération
            ...
            try:
                ...
                if hasattr(Competition, 'discipline'):
                    ...
                    competitions = Competition.objects.filter(federation=federation) if hasattr(Competition, 'federation') else get_organization_queryset(Competition, self.request.user)
