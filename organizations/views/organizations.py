"""
Vues liées à la gestion des organisations.
"""
...
class OrganizationUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def form_valid(self, form):
        """Traitement lorsque le formulaire est valide."""
        messages.success(self.request, _("L'organisation a été mise à jour avec succès."))
        return super().form_valid(form)
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if has_affiliations:
            messages.error(request, _(
                "Cette organisation ne peut pas être supprimée car elle a des affiliations. "
